<h1 class="text-center">BIENVENIDO UPON DELIVERY</h1>
<hr>
<style>
  h1{
    color:black
...
<div class="row">
          <div class="col-12 col-sm-4 col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Informacion de categorias</span>
          ...
          <div class="col-12 col-sm-4 col-md-4">
            <div class="info-box">
              <span class="info-box-icon bg-gradient-navy elevation-1"><i class="fas fa-th-list"></i></span>
              <div class="info-box-content">
                <span class="info-box-text">Informacion de Productos</span>
                <span class="info-box-number text-right">
                  <?php 
                    $product = $conn->query("SELECT * FROM product_list where delete_flag = 0 and `status` = 0")->num_rows;
          ...
          <div class="col-12 col-sm-4 col-md-4">
            <div class="info-box">
              <span class="info-box-icon bg-gradient-navy elevation-1"><i class="nav-icon fas fa-file-invoice"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Informacion de Pedidos</span>
                <span class="info-box-number text-right">
                  <?php 
