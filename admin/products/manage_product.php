	...
	<form action="" id="product-form">
		...
		<div class="form-group">
			...
			<select name="status" id="status" class="form-control form-control-sm rounded-0" required>
				<option value="1" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Pedido Por Pagar</option>
				<option value="0" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>Pedido Pagado</option>
			</select>
		</div>
	</form>
</div>
