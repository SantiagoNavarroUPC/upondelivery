		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile1">Elija el archivo</label>
	            </div>
			</div>
			...
			<div class="form-group">
				...
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile3">Elija archivos</label>
	            </div>
				<small><i>Elija cargar nuevas imágenes</i></small>
			</div>
			<?php 
...
<script>
	...
	$(document).ready(function(){
		$('.rem_img').click(function(){
            _conf("¿Estás segura de eliminar esta imagen de forma permanente?",'delete_img',["'"+$(this).attr('data-path')+"'"])
        })
