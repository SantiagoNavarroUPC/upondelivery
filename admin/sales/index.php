...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		<h3 class="card-title">Modulo de Pedidos</h3>
		<div class="card-tools">
			<a href="./?page=sales/manage_sale" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Creación Nueva</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td align="center">
								<a class="btn btn-default bg-gradient-light btn-flat btn-sm" href="?page=sales/view_details&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> Vista</a>
							</td>
						</tr>
					<?php endwhile; ?>
				</tbody>
