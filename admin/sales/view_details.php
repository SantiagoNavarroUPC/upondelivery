...
<div class="content py-3">
    <div class="card card-outline card-navy rounded-0 shadow">
        <div class="card-header">
            <h4 class="card-title">Detalles de venta: <b><?= isset($code) ? $code : "" ?></b></h4>
            <div class="card-tools">
                <a href="./?page=sales" class="btn btn-default border btn-sm"><i class="fa fa-angle-left"></i> Volver a la lista</a>
            </div>
        </div>
        <div class="card-body">
            <div class="container-fluid row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12"  id="printout">
                    ...
                    <h4 class="d-flex border-bottom border-dark">
                        ...
                        <div class="col-7 text-center">Artículo</div>
                    ...
                    <h5 class="d-flex">
                        <div class="col-4">Código de pago</div>
                        <div class="col-8 text-right"><?= isset($payment_code) ? $payment_code : "" ?></div>
                    </h5>
                    <?php endif; ?>
                    <div class="d-flex">
                        <div class="col-auto"><b>Procesado por:</b></div>
            ...
            <div class="row justify-content-center">
                <a class="btn btn-primary bg-gradient-primary border col-lg-3 col-md-4 col-sm-12 col-xs-12 rounded-pill" href="./?page=sales/manage_sale&id=<?= isset($id) ? $id : '' ?>"><i class="fa fa-edit"></i> Editar</a>
                ...
                <button class="btn btn-danger bg-gradient-danger border col-lg-3 col-md-4 col-sm-12 col-xs-12 rounded-pill" id="delete_sale" type="button"><i class="fa fa-trash"></i> Eliminar Venta</button>
            </div>
        </div>
    </div>
</div>
<noscript id="print-header">
    ...
    <div class="d-flex w-100">
        ...
        <div class="col-8 text-center">
            <h4 class="tex-center">Upon Delivery</h4>
            <h3 class="text-center"><b>Factura de pedido pagado</b></h3>
        </div>
    </div>
    <hr>
</noscript>
...
$(function(){
    $('#print').click(function(){
        ...
        head.find('title').text("Detalles de la entrega")
        el.append(phead)
        el.append(p)
    ...
    $('#delete_sale').click(function(){
        _conf("¿Estás segura de eliminar esta facturacion de forma permanente?","delete_sale",[])
    })
})
