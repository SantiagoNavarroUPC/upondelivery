    ...
    <div class="container-fluid">
        <div class="card card-outline card-outline rounded-0 shadow blur">
            <div class="card-header">
                <h5 class="card-title"><?= isset($id) ? "Actualizar ". $code . " Pedido" : "Nueva Facturacion de Pedido" ?></h5>
            </div>
            <div class="card-body">
                <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="client_name" id="client_name" class="form-control form-control-sm rounded-0" value="<?= isset($client_name) ? $client_name : "Cliente Invitado" ?>" required="required">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-bordered table-striped mb-0">
                                        ...
                                        <thead>
                                            <tr class="bg-gradient-navy-dark">
                                                <th class="text-center px-2 py-1">Cantidad</th>
                                                <th class="text-center px-2 py-1">Nombre del Pedido</th>
                                                <th class="text-center px-2 py-1">Precio de la Entrega</th>
                                    ...
                                    <h3 class="d-flex w-100 align-items-center">
                                        ...
                                        <div class="col-8">
                                            <select name="payment_type" id="payment_type" class="form-control rounded-0" required="required">
                                                <option value="1" <?= isset($payment_type) && $payment_type == 1 ? "selected" : "" ?>>Efectivo</option>
                                                <option value="2" <?= isset($payment_type) && $payment_type == 2 ? "selected" : "" ?>>Tarjeta de debito </option>
                                                <option value="3" <?= isset($payment_type) && $payment_type == 3 ? "selected" : "" ?>> Tarjeta de credito</option>
                                            </select>
                                        </div>
                                    </h3>
            ...
            <div class="card-footer py-2 text-right">
                <button class="btn btn-primary rounded-0" form="sale-form">Guardar Facturacion</button>
                <?php if(!isset($id)): ?>
                <a class="btn btn-default border rounded-0" href="./?page=sales">Cancelar</a>
                <?php else: ?>
                <a class="btn btn-default border rounded-0" href="./?page=sales/view_details&id=<?= $id ?>">Cancelar</a>
                <?php endif; ?> 
            </div>
        </div>
    </div>
