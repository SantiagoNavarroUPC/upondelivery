...
<div class="card card-outline rounded-0 card-navy">
	...
	<div class="card-header">
		<h3 class="card-title">Modulo de Categorias</h3>
					...
					?>
						<tr>
							...
							<td class="text-center">
                                <?php if($row['status'] == 1): ?>
                                    <span class="badge badge-success px-3 rounded-pill">Activa</span>
                                <?php else: ?>
                                    <span class="badge badge-danger px-3 rounded-pill">Inactiva</span>
                                <?php endif; ?>
                            </td>
							<td align="center">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("¿Estás segura de eliminar esta categoría de forma permanente?","delete_category",[$(this).attr('data-id')])
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Añadir Nueva Categoria","categories/manage_category.php")
		})
		$('.view_data').click(function(){
			uni_modal("<i class='fa fa-bars'></i> Detalles de Categoria","categories/view_category.php?id="+$(this).attr('data-id'))
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Actualizar detalles de la categoría","categories/manage_category.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
